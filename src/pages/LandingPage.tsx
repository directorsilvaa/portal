...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section id="inicio" className="relative bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 text-white overflow-hidden min-h-screen flex items-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-200 leading-relaxed max-w-lg">
                ...
                Metodologia comprovada, certificação reconhecida e suporte especializado.
              </p>
            ...
            <div className="relative">
              <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl p-8 space-y-6 border border-white border-opacity-20 shadow-2xl">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Mentoria Exclusiva</h3>
                ...
                <div className="pt-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-300">Progresso médio dos alunos</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Metodologia que
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600"> Funciona</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nossa abordagem única combina teoria e prática para garantir resultados reais
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group text-center p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Flexibilidade Total</h3>
              <p className="text-gray-600 leading-relaxed">
                Estude quando quiser, onde quiser, no seu próprio ritmo e horário
              </p>
            </div>
            ...
            <div className="group text-center p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Suporte Humanizado</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="group text-center p-8 bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                98% dos nossos alunos conseguem melhores oportunidades profissionais
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="cursos" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Cursos que
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600"> Transformam</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Desenvolvidos por especialistas do mercado para impulsionar sua carreira ao próximo nível
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Resultados reais de uma década transformando vidas através da educação
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-blue-100 text-lg">Alunos Certificados</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold mb-2 text-green-400">50+</div>
              <div className="text-blue-100 text-lg">Cursos Especializados</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold mb-2 text-pink-400">98%</div>
              <div className="text-blue-100 text-lg">Taxa de Satisfação</div>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold mb-2 text-orange-400">10+</div>
      ...
      <section className="py-24 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Junte-se a milhares de profissionais que já transformaram suas carreiras com nossos cursos premium
          </p>
